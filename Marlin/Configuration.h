...
#define STRING_CONFIG_H_AUTHOR "DVAR" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_REDUNDANT_MAX_DIFF 10 // TEMP_SENSOR_REDUNDANT_MAX_DIFF (°C)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48.25, 0, 0 }
